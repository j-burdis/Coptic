...
ActiveRecord::Schema[7.2].define(version: 2026_05_06_191153) do
  ...
  create_table "artworks", force: :cascade do |t|
    ...
    t.index ["date_display"], name: "index_artworks_on_date_display"
  ...
  create_table "carousel_slides", force: :cascade do |t|
    ...
    t.string "quote_attribution_date"
  end
  ...
  create_table "category_pages", force: :cascade do |t|
    ...
    t.index ["year"], name: "index_category_pages_on_year"
  end
